...
HASCALM-19
    ...
    <div class="container" id="main">
      <center><h1>S-XIX Tienda</h1></center>
      <br>
        <div class="row">
            <?php
              ...
              <div class="col-md-3">
                  <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                      <?php
                          $foto = 'images/'.$item['foto'];  
                          if(file_exists($foto)){
                        ?>
                          <a href="VerDetalleProducto.php?id=<?php print $item['id'] ?>"><img src="<?php print $foto; ?>" class="img-responsive imgListas"></a>
                      <?php }else{?>
