  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"><i class="fas fa-store"></i>
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav pull-right">
          <li>
            <a href="" class="btn"><i class="fas fa-shopping-cart"></i> <span
                class="badge"><?php print cantidadPeliculas(); ?></span></a>
          </li>
        </ul>
      </div>
      <!--/.nav-collapse -->
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          <form action="actualizar_carrito.php" method="post">
            ...
            <td><?php print $value['precio']  ?> RD</td>
            <td>
      ...
      <tfoot>
        <tr>
          ...
          <td><?php print calcularTotal(); ?> RD</td>
          <td></td>
        </tr>
    ...
    <div class="row">
      ...
      <div class="pull-right">
        <form action="completar_pedido.php" method="post">
          <a href="completar_pedido.php" class="btn btn-success">Comprar</a>
        </form>
      </div>
    </div>
