  ...
  <body>
    ...
    <br>
            <div class="CentralBTN">      
              <a href="cancelarPedidoPorID.php" id="btnImprimir" class="btn btn-danger hidden-print">Borrar listar</a>  
            </div>
...
<br>
	...
	<div class="body-footer">
      ...
      <h4 class="mb10">Redes sociales</h4>
				...
				<br>
				<a href="" target="_blank">Whatsapp: 809 216 4930</a>
			</div>
			<div class="part">
			</div>
		</div>
		<center><h5>Matshop - Derechos reservador 2021</h5></center>
	</div>
</footer>
